# -*- coding: utf-8 -*-
#
# srsRAN documentation build configuration file, created by
...
htmlhelp_basename = 'srsRAN_4G_doc'
...
latex_documents = [
    (master_doc, 'srsRAN_4G.tex', u'srsRAN 4G Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'srsRAN 4G', u'srsRAN 4G Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'srsRAN 4G', u'srsRAN 4G Documentation',
     author, 'srsRAN 4G', 'One line description of project.',
     'Miscellaneous'),
]
